...
describe Sportsdata do
  ...
  context "Sports Data Config" do
    it "should be able to configure api keys and mode" do
        ...
        subject.nhl_api_key.should == ENV['SPORTSDATA_NHL_API_KEY']
        subject.nhl.api_key.should == ENV['SPORTSDATA_NHL_API_KEY']
        subject.nba_api_key.should == ENV['SPORTSDATA_NBA_API_KEY']
        subject.nba.api_key.should == ENV['SPORTSDATA_NBA_API_KEY']
        subject.mlb_api_key.should == ENV['SPORTSDATA_MLB_API_KEY']
        subject.mlb.api_key.should == ENV['SPORTSDATA_MLB_API_KEY']
